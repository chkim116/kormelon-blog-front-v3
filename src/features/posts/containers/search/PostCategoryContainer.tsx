...
import { PostCardListByCategory } from '@features/posts/components/search/PostCardListByCategory';
import { PostModel } from '@features/posts/models/post.model';
import { selPostLoading, selPostSearchParams } from '@features/posts/stores';
...
export const PostCategoryContainer = ({
  ...
  const loading = useAppSelector(selPostLoading);
  const {
    page = DEFAULT_PAGE,
    categoryId = 0,
    subCategoryId = 0,
